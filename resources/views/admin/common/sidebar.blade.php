            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a  class="nav-link dropdown-toggle " href="{{url('/admin')}}" id="topnav-dashboard" role="button" ><i class="fa fa-dashboard"></i> Dashboards 
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                   ...
                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.categories.index') }}" class="dropdown-item">Categories</a>
                                   @endif

                                   @endif
                                   @if(CustomHelper::isAllowedModule('courses'))
                                   @if(CustomHelper::isAllowedSection('courses' , 'list'))
                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.courses.index') }}" class="dropdown-item">Courses</a>

                                   @endif
                                   @endif
                                   @if(CustomHelper::isAllowedModule('subject'))
                                   
                                   @if(CustomHelper::isAllowedSection('subject' , 'list'))
                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.subject.index') }}" class="dropdown-item">Subjects</a>
                                   @endif
                                   @endif

                                   @if(CustomHelper::isAllowedModule('banners'))
                                   @if(CustomHelper::isAllowedSection('banners' , 'list'))
                                   <a href="{{ route($ADMIN_ROUTE_NAME.'.banners.index') }}" class="dropdown-item">Banners</a>
                                   @endif
                                   @endif
                       ...
                       <?php }?>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                           @if(CustomHelper::isAllowedModule('faculties'))
                           @if(CustomHelper::isAllowedSection('faculties' , 'list'))
                           <a href="{{ route($ADMIN_ROUTE_NAME.'.faculties.index') }}" class="dropdown-item">Faculty</a>
                           @endif
                           @endif
                           ...
                           <a href="{{ route($ADMIN_ROUTE_NAME.'.user.index') }}" class="dropdown-item">Users</a>
                           @endif
                           @endif
               ...
               <?php }?>
                   ...
                   @if(CustomHelper::isAllowedModule('live_class'))
                           @if(CustomHelper::isAllowedSection('live_class' , 'list'))

                   <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.live_class.index') }}" id="topnav-components" role="button" class="nav-link dropdown-toggle "><i class="fa fa-television"></i> Live Classes</a>
                </li>
                @endif
                @endif
                ...
                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.subscriptions.index') }}" id="topnav-components" role="button" class="nav-link dropdown-toggle "><i class="fa fa-rocket"></i>  Subscription History</a>
                ...
                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.chats.index') }}" id="topnav-form" role="button" class="nav-link dropdown-toggle "><i class="fa fa-comments"></i> Chats</a>
                ...
                @if(CustomHelper::isAllowedModule('contacts'))
                           @if(CustomHelper::isAllowedSection('contacts' , 'list'))

                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.contacts.index') }}" id="topnav-form" role="button" class="nav-link dropdown-toggle "><i class="fa fa-address-book"></i> Contact Us</a>
                ...
                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.notifications.index') }}" id="topnav-form" role="button" class="nav-link dropdown-toggle "><i class="fa fa-bell"></i> Notifications</a>
                ...
                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.faqs.index') }}" id="topnav-form" role="button" class="nav-link dropdown-toggle "><i class="fa fa-question-circle" aria-hidden="true"></i> FAQs</a>
                ...
                @if(CustomHelper::isAllowedModule('dgl_form'))
                           @if(CustomHelper::isAllowedSection('dgl_form' , 'list'))

                <li class="nav-item dropdown">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.dgl_form.index') }}" id="topnav-form" role="button" class="nav-link dropdown-toggle "><i class="fa fa-wpforms" aria-hidden="true"></i> DGL Form</a>
