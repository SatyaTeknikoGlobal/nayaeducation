                ...
                <?php } }?>
                 ...
                 <div class="mb-3">
                  <label for="fullname" class="form-label">Monthly Amount</label>
                   <input class="form-control mb-3" type="number" name="monthly_amount" value="{{ old('monthly_month',$monthly_month) }}" id="monthly_amount" placeholder="Enter Monthly Amount" aria-label="default input example">

                </div>

                 <div class="mb-3">
                  <label for="fullname" class="form-label">Syllabus</label>
                   <textarea class="form-control mb-3" name="syllabus" id="description"  placeholder="Write Syllabus Description .........." aria-label="default input example">{{ old('syllabus',$syllabus) }}</textarea>
