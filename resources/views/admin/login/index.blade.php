                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center d-flex">
                          <!-- <center><img class="logo-img" src="{{asset('public/assets/images/logo/logo.png')}}" alt="logo" width="{conf.logoWidth}" height="100" width="100"><span class="splash-description"></center> -->
                          <!-- <img class="logo-img" src="{{asset('public/assets/images/logo/text.png')}}" alt="logo" width="{conf.logoWidth}" height="100" width="100"> -->
