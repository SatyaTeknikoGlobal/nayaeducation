          ...
          <div class="page-title-box">
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
               <a href="<?php echo e(route($routeName.'.subject.add', ['back_url' => $BackUrl])); ?>" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i>Add Subject</a>
              </ol>
            </div>
              ...
              ?>   
                ...
                <tr>
                 ...
                 ?>          
                  ...
                  <td><?php echo e($b->subject_name); ?></td>                 
                  <td>
                    <?php
                      if($b->status == 1){ ?>
                        Active
                ...
                <?php echo e($subject->appends(request()->input())->links('admin.pagination')); ?>
...
<?php /**PATH /home/appmantr/public_html/nayaeducation/resources/views/admin/subject/index.blade.php ENDPATH**/ ?>