      ...
      <form class="card-body" action="" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
        ...
        <div class="card">
          <div class="card-body"> 
            ...
            <div class="col-md-7"><input type="text" class="form-control mb-3" name="subject_name" value="<?php echo e(old('subject_name',$subject_name)); ?>" id="subject_name" placeholder="Enter Batch" aria-label="default input example"></div>
        </div>
...
<?php /**PATH /home/appmantr/public_html/nayaeducation/resources/views/admin/content/form.blade.php ENDPATH**/ ?>