        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="card-body" action="" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
             ...
             <input type="hidden" name="id" value="<?php echo e($faq_id); ?>">
             <div class="mb-3">
              <label for="fullname" class="form-label">Question</label>
              <textarea class="form-control mb-3"  name="questions" id="questions" placeholder="Write Question" aria-label="default input example"><?php echo e(old('questions',$questions)); ?></textarea>

            </div>

            <div class="mb-3">
              <label for="email" class="form-label">Answer</label>
              <textarea class="form-control mb-3"name="answer" id="answer"  placeholder="Write Answer .........." aria-label="default input example"><?php echo e(old('answer',$answer)); ?></textarea>
            </div>
...
<?php /**PATH /home/appmantr/public_html/nayaeducation/resources/views/admin/faqs/form.blade.php ENDPATH**/ ?>